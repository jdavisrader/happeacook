...
class IngredientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update ingredient" do
    patch ingredient_url(@ingredient), params: { ingredient: { measurement: @ingredient.measurement, name: @ingredient.name, order_number: @ingredient.order_number, recipe_id: @ingredient.recipe_id } }
